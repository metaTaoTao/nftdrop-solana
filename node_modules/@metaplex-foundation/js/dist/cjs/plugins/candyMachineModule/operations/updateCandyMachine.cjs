...
const updateCandyGuardAuthorityBuilder = (metaplex, params, candyGuardAuthority, payer, programs) => {
  var _params$candyGuard;

  if (!params.newCandyGuardAuthority) {
    return TransactionBuilder.TransactionBuilder.make();
  }

  const candyGuardAddress = (_params$candyGuard = params.candyGuard) !== null && _params$candyGuard !== void 0 ? _params$candyGuard : CandyMachine.isCandyMachine(params.candyMachine) && params.candyMachine.candyGuard ? params.candyMachine.candyGuard.address : null;
