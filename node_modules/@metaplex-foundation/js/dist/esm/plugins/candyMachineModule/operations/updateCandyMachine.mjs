...
const updateCandyGuardAuthorityBuilder = (metaplex, params, candyGuardAuthority, payer, programs) => {
  ...
  const candyGuardAddress = (_params$candyGuard = params.candyGuard) !== null && _params$candyGuard !== void 0 ? _params$candyGuard : isCandyMachine(params.candyMachine) && params.candyMachine.candyGuard ? params.candyMachine.candyGuard.address : null;
